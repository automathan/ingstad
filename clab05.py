...
spec = NetworkSpecification(hidden_layer_sizes=[6,4], activation_function=nn.Sigmoid)
dqn = DQN(env, spec, render=True, alpha=0.01, epsilon_start=0.8, epsilon_end=0.01, memory_length=2000)
